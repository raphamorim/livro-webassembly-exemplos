...
static u32 w2c_subtracao(Z_moduloZ2Daritmetico_instance_t*, u32, u32);
static u32 w2c_divisao(Z_moduloZ2Daritmetico_instance_t*, u32, u32);
static u32 w2c_multiplicacao(Z_moduloZ2Daritmetico_instance_t*, u32, u32);

static u32 w2c_soma(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = w2c_p0;
  w2c_i1 = w2c_p1;
...
static u32 w2c_subtracao(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = w2c_p0;
  w2c_i1 = w2c_p1;
...
static u32 w2c_divisao(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = w2c_p0;
  w2c_i1 = w2c_p1;
...
static u32 w2c_multiplicacao(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = w2c_p0;
  w2c_i1 = w2c_p1;
...
/* export: 'soma' */
u32 Z_moduloZ2DaritmeticoZ_soma(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_soma(instance, w2c_p0, w2c_p1);
}

/* export: 'subtracao' */
u32 Z_moduloZ2DaritmeticoZ_subtracao(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_subtracao(instance, w2c_p0, w2c_p1);
}

/* export: 'divisao' */
u32 Z_moduloZ2DaritmeticoZ_divisao(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_divisao(instance, w2c_p0, w2c_p1);
}

/* export: 'multiplicacao' */
u32 Z_moduloZ2DaritmeticoZ_multiplicacao(Z_moduloZ2Daritmetico_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
  return w2c_multiplicacao(instance, w2c_p0, w2c_p1);
}
...
void Z_moduloZ2Daritmetico_instantiate(Z_moduloZ2Daritmetico_instance_t* instance) {
  assert(wasm_rt_is_initialized());
  assert(s_module_initialized);
}

void Z_moduloZ2Daritmetico_free(Z_moduloZ2Daritmetico_instance_t* instance) {
}
